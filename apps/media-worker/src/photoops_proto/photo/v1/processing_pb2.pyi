...
class ImageAttributes(_message.Message):
    __slots__ = ("width", "height", "taken_at_local", "taken_at_utc", "taken_at_tz_source", "camera_make", "camera_model", "orientation", "lat", "lon")
    ...
    lat: float
    lon: float
    def __init__(self, width: _Optional[int] = ..., height: _Optional[int] = ..., taken_at_local: _Optional[str] = ..., taken_at_utc: _Optional[str] = ..., taken_at_tz_source: _Optional[str] = ..., camera_make: _Optional[str] = ..., camera_model: _Optional[str] = ..., orientation: _Optional[int] = ..., lat: _Optional[float] = ..., lon: _Optional[float] = ...) -> None: ...
