...
@Module({
  ...
  controllers: [HealthController, AuthController, PhotoController, UsageController, ClusterController],
  providers: [IdentityClient, AuthService, PhotoClient, UsageClient, ClusterClient]
})
